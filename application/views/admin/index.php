        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
          <ul class="navbar-nav">
            <li class="nav-item fw-semibold d-none d-lg-block ms-0">
              <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold">Suraj</span></h1>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=blog&table=blogs">Blogs Table</a></li>
                  <li class="nav-item"> <a class="nav-link" href="http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=blog&table=users">Users Table</a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('admin/blogs/create'); ?>">Add Blog</a></li>
                  <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('admin/blogs'); ?>">View Blog</a></li>
                </ul>
              </div>
            </li>
                                    ...
                                    <table class="table select-table">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex ">
                                              <img src="<?= base_url() ?>assets/admin/images/faces/face1.jpg" alt="">
                                              <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="<?= base_url() ?>assets/admin/images/faces/face2.jpg" alt="">
                                              <div>
                                                <h6>Laura Brooks</h6>
                                                <p>Head admin</p>
                                              </div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="<?= base_url() ?>assets/admin/images/faces/face3.jpg" alt="">
                                              <div>
                                                <h6>Wayne Murphy</h6>
                                                <p>Head admin</p>
                                              </div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="<?= base_url() ?>assets/admin/images/faces/face4.jpg" alt="">
                                              <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="<?= base_url() ?>assets/admin/images/faces/face5.jpg" alt="">
                                              <div>
                                    ...
                                    <div class="col-lg-12">
                                      ...
                                      <div class="mt-3">
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="<?= base_url() ?>assets/admin/images/faces/face1.jpg" alt="profile">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="<?= base_url() ?>assets/admin/images/faces/face2.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="<?= base_url() ?>assets/admin/images/faces/face3.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="<?= base_url() ?>assets/admin/images/faces/face4.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="<?= base_url() ?>assets/admin/images/faces/face5.jpg" alt="profile">
                                            <div class="wrapper ms-3">
